...
namespace bluez.DBus
{
    ...
    class Device1Properties
    {
        ...
        private IDictionary<ObjectPath, IDictionary<string, object>> _Sets = default(IDictionary<ObjectPath, IDictionary<string, object>>);
        public IDictionary<ObjectPath, IDictionary<string, object>> Sets
        {
            get
            {
                return _Sets;
    ...
    static class Device1Extensions
    {
        ...
        public static Task<IDictionary<ObjectPath, IDictionary<string, object>>> GetSetsAsync(this IDevice1 o) => o.GetAsync<IDictionary<ObjectPath, IDictionary<string, object>>>("Sets");
